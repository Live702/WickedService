...
public partial class LzSubscriptionModelValidator : FluentValidation.AbstractValidator<LzSubscriptionModel>
{
    public LzSubscriptionModelValidator()
    {
        Include(new LzSubscriptionValidator());
        CustomValidation();
    }
