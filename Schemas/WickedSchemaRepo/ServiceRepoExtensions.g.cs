...
public static partial class WickedSchemaRepoExtensions
{
    public static IServiceCollection AddWickedSchemaRepo(this IServiceCollection services)
    {

        services.TryAddAWSService<Amazon.DynamoDBv2.IAmazonDynamoDB>();
		services.TryAddSingleton<IBlurbRepo, BlurbRepo>();
		services.TryAddSingleton<IMessageRepo, MessageRepo>();
		services.TryAddSingleton<IPremiseRepo, PremiseRepo>();
		services.TryAddSingleton<IChatRepo, ChatRepo>();
