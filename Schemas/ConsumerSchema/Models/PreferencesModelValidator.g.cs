...
public partial class PreferencesModelValidator : FluentValidation.AbstractValidator<PreferencesModel>
{
    public PreferencesModelValidator()
    {
        Include(new PreferencesValidator());
        CustomValidation();
    }
