...
namespace SubscriptionsModule
{
    ...
    public interface ISubscriptionsModuleController
    {
    ...
    public abstract partial class SubscriptionsModuleController : Microsoft.AspNetCore.Mvc.Controller,ISubscriptionsModuleController
    {
        ...
        {
            var callerInfo = await subscriptionsModuleAuthorization.GetCallerInfoAsync(this.Request);
		...
		protected ISubscriptionsModuleAuthorization subscriptionsModuleAuthorization;
